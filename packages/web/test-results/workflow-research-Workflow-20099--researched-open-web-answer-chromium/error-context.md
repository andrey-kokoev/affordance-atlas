    ...
    - list:
      - listitem:
        - button "When is Grand Central Terminal open in New York?completed":
          ...
          - text: completed
        - paragraph: "Answer: Grand Central Terminal offers public visiting hours on daily.. Select this job to jump to it."
```
